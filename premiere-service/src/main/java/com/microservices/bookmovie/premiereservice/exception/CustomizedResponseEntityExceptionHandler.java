...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public final ResponseEntity<ExceptionResponse> handleMethodArgumentTypeMismatchException(
          Exception ex, WebRequest request) {
    String message = "Parse attempt failed for value "+ ((MethodArgumentTypeMismatchException) ex).getValue()+" due to invalid format. Correct format to be used [yyyy-MM-dd]";
    ExceptionResponse exceptionResponse =
